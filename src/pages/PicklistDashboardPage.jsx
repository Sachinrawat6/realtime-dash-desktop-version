...
const PicklistDashboardPage = () => {
    ...
    const LOCALE_URL = "http://localhost:5000";
    ...
    const fetchReport = async (date = selectedDate) => {
        ...
        try {
            ...
            // const URL = `${LOCALE_URL}/${SUB_URL}${date ? `?date=${date}` : ''}`;
            const URL = `${BASE_URL}/${SUB_URL}${date ? `?date=${date}` : ''}`;
            ...
            <div className="bg-white shadow-sm border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Picklist Performance Dashboard</h1>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                            >
