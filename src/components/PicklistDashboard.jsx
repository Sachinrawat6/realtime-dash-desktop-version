...
const ProfessionalDashboard = ({ reportData, selectedDate }) => {
    ...
    //         let efficiency = 0;
    //         if (expected > 0) {
    //             efficiency = (firstFound / expected) * 100;
    //         }
    //         efficiency = Number(efficiency.toFixed(2));

    //         // FIRST ATTEMPT
    //         firstAttemptMap[emp.picklist_id] = {
    //             emp_id: emp.firstAttemptEmployeeId ?? 0,
    //             total_expected_found: expected,
    //             total_found: firstFound,
    //             efficiency,
    //             remaining_to_found: expected - firstFound
    //         };

    //         // SECOND ATTEMPT
    //         if (emp.secondAttemptEmployeeId) {
    //             secondAttemptMap[emp.picklist_id] = {
    //                 emp_id: emp.secondAttemptEmployeeId,
    //                 second_attempt_found: emp.actualFoundSecondAttempt ?? 0,
    //                 remaining_for_found: expected - firstFound,
    //             };
    //         }
    //     });

    //     setSummary({ firstAttemptMap, secondAttemptMap });
    // };
